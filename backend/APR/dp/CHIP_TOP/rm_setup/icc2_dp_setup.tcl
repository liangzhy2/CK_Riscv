...
set DISTRIBUTED 1  ;# Use distributed runs
### It is required to include the set_host_options command to enable distributed mode tasks. For example,
set_host_options -max_cores 8 
#set_host_options -name block_script -submit_command [list qsub -P bnormal -l mem_free=6G,qsc=m -cwd]
...
set BOTTOM_BLOCK_VIEW             "abstract" ;# Support abstract or design for bottom blocks
                                             ;# in the hier flow
...
set CONGESTION_DRIVEN_PLACEMENT       "" ;# Set to one of the following: std, macro, or both to enable congestion driven placement
set TIMING_DRIVEN_PLACEMENT           "" ;# Set to one of the following: std, macro, or both to enable timing driven placement
...
##########################################################################################
set TCL_CTS_CONSTRAINTS_FILE                  "" ;# Specify a Tcl script to define CTS constraints for Clock Trunk Planning purposes;
                                                 ;# An example is provided in rm_icc2_pnr_scripts/settings.common.cts.tcl
set CTP_DERATE_PERCENT                        "" ;# Specify a clock derate percentage to enable CRP estimation
