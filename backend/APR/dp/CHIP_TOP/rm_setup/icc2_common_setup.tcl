...
set LIBRARY_SUFFIX		".nlib" ;# Suffix for the design library name ; default is unspecified   
...
set TECH_FILE 			"" 	;# A technology file; TECH_FILE and TECH_LIB are mutually exclusive ways to specify technology information; 
